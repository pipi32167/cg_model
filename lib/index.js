...
exp.getCacheClient = function(name) {
  var conns = exp.get('conns');
...
exp.initialize = function(config) {
  ...
  exp.initDebugMode(config.debug_mode);
}

exp.initDebugMode = function (debug_mode) {
