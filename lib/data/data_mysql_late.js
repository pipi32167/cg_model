...
var runJobs = function() {
  ...
  async.whilst(
    ...
    function(cb) {
      ...
      model.logger.debugSql('run sql:', q.sql);
    },
    function() {
      isRunningJobs = false;
    });
